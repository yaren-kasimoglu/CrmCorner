...
namespace CrmCorner.Models
{
	public class GoogleCalendarService : IGoogleCalendarService
    {
        ...
        public async Task<GoogleTokenResponse> GetTokens(string code)
        {
            ...
            var clientId = "928553971028-0vuo5440mfuj5qknoqf715ko4k6jg9pj.apps.googleusercontent.com";
            string clientSecret = "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";
            var redirectURL = "https://localhost:7272/auth/callback";
        ...
        public string AddToGoogleCalendar(Calendar googleCalendarReqDTO)
        {
            try
            {
                var token = new TokenResponse
                {
                    RefreshToken ="sfsfsfkjsndskjfnsvkjnskjfvmklef"
                };
                var credentials = new UserCredential(new GoogleAuthorizationCodeFlow(
                  new GoogleAuthorizationCodeFlow.Initializer
                  {
                      ...
                      {
                          ClientId = "928553971028-0vuo5440mfuj5qknoqf715ko4k6jg9pj.apps.googleusercontent.com",
                          ClientSecret = "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"
                      }
                ...
                {
                    Summary = googleCalendarReqDTO.Title,
                    Description = googleCalendarReqDTO.Description,
                    Start = new EventDateTime()
                    {
                        DateTime = Convert.ToDateTime(googleCalendarReqDTO.Date),
                ...
                EventsResource.InsertRequest insertRequest = service.Events.Insert(newEvent, googleCalendarReqDTO.Id.ToString());
